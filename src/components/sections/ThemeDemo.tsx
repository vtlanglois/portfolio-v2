          ...
          <Stack>
            ...
            <Card className="flex flex-col gap-3">
              <p>
                ...
                had an About, Education, Experience, and Projects sections. Not
                to say those are <i>bad</i>, but after doing it for the third
                time I wanted a change and a <b>challenge</b>.
              </p>
              <p>
              ...
              <ol className="list-decimal list-inside">
                <li>
                  ...
                  add a feature where the user could change the site&apos;s
                  theme to another, beyond just Light and Dark Mode. I had some
                  experience working with themes from building a colorblind
                  palette accessibility setting for a game project, so I wanted
                  to try out a creative version on a website.
                </li>
                <li>
                  <b>Unique look</b>: I didn&apos;t want another site with a
                  single background color. I wanted something that reminded me
                  of expressive sites from my childhood but built with modern
                  tools and a better understanding of site accessibility.
                </li>
                <li>
                  <b>Great feel:</b> all of my sites were pretty static without
                  many complex parts. This was intentional, as I wanted the
                  sites out to let people know who I was without burning myself
                  out. Now that I got a few years in my career, I wanted to
                  showcase that here rather than hope people see my work out in
                  the wild. I wanted this portfolio to feel great to use and
                  navigate.
                </li>
              </ol>
              <p>
                These challenges landed me to decide on a natural / Frutiger
                Aero themed background with a set of hill SVGs and a standard
                white card + black text foreground. This allowed for the
                following:
              </p>
              <ul className="list-disc list-inside">
                <li>
                  Plenty of theme ideas. Hills could be seen as plains, water,
                  deserts, desserts, clouds, snows, and so much more with a
                  simple color change! Plus, I do enjoy 2000s internet
                  aesthetics, so it all helped inspire me through this project.
                </li>
                <li>
                  Unique look without reducing accessibility. Black text on a
                  blue background is hard to read. However, with all the black
                  text shown on top of white cards, the background could be
                  whatever it wanted and the text would still pass contrast
                  standards. Plus, it complemented the Frutiger Aero theme with
                  the squircle look!
                </li>
              </ul>
              <p>
                I&apos;m quite happy with how this site turned out, so much so I
                don&apos;t really see myself throwing this out for quite a
                while. It still has many improvements to make, such as
                optimization, but those will help me become an even better
                engineer! I&apos;ll welcome a good challenge, especially ones
                with a calming theme.
              </p>
            </Card>
          </Stack>
        </Container>
          ...
          <Stack>
            ...
            <div className="grid grid-rows-1 lg:grid-cols-4 gap-4">
              ...
              <ThemeCard theme="winter">
                <p>
                  My favorite season! This theme transforms the hills into
                  mounds of snow. Based on winter walks and photos of local
                  parks.
                </p>
              </ThemeCard>
              ...
              <ThemeCard theme="misty">
                <p>
                  ...
                  darker colors make the hills feel bigger IMO. Inspired by
                  Turkey Run State Park too!
                </p>
              </ThemeCard>
              ...
              <ThemeCard theme="dunes">
                <p>
                  The third theme made for the site! Second idea after seeing
                  the hills was that this could also be a desert. Named after
          ...
          <Stack>
            ...
            <div className="grid grid-rows-1 lg:grid-cols-4 gap-4">
              ...
              <ThemeCard theme="aqua">
                Aqua started as an attempt at an underwater theme mixing the
                Ocean and Dunes theme. The colors didn&apos;t really end up
                working, but the ocean &quot;sky&quot; reminded me a bit of
                Apple&apos;s Aqua theme.
              </ThemeCard>
              <ThemeCard theme="dorfic">
                <p>
                  Personally, I&apos;m not the biggest fan of DORFic. However,
                  the orange background goes very well the white cards used in
                  Light Mode. Plus, adds another warm theme.
                </p>
              </ThemeCard>
            </div>
          </Stack>
            ...
            <div className="grid grid-rows-1 lg:grid-cols-3 gap-4">
              <ThemeCard theme="blocks">
                <p>
                  ...
                  before settling on nature and 2000s internet aesthetics.
                  Wanted to include it as a theme to show a &quot;What if?&quot;
                  version of the site. Has an easter egg where all UI elements
                  become blocky.
                </p>
              </ThemeCard>
              <ThemeCard theme="neopolitan">
                <p>
                  As I was working on the site, I wanted to include something
                  that would use the hills in a way that <i>wasn&apos;t</i>{" "}
                  based on nature or 2000s internet aesthetics. From that, a
                  friend told me the hills looked like ice cream.
                </p>
              </ThemeCard>
              <ThemeCard theme="plain">
                <p>
                  I didn&apos;t know what the last theme would be, so a plain
                  theme both helps to inform the user about the end of themes
                  list and easily transition the user back to Bliss.
                </p>
              </ThemeCard>
            </div>
          </Stack>
