...
export default function Footer() {
  ...
  "
      ...
      <div className="bg-(--footer) text-white">
        <Container>
          <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start pb-4 lg:pb-0">
            <div>
              <p className="pb-4 text-center lg:text-start text-sm">
                ...
                Inspired by Frutiger Aero, nature, and similar 2000s aesthetics.
              </p>
            </div>
